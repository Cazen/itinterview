...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "itinterview@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "itinterview API";

        private String description = "itinterview API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "itinterview";
