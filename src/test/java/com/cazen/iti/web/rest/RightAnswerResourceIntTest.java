...
public class RightAnswerResourceIntTest {
    ...
    public void createRightAnswer() throws Exception {
        ...
        List<RightAnswer> rightAnswers = rightAnswerRepository.findAll();
        assertThat(rightAnswers).hasSize(databaseSizeBeforeCreate + 1);
        RightAnswer testRightAnswer = rightAnswers.get(rightAnswers.size() - 1);
    ...
    public void updateRightAnswer() throws Exception {
        ...
        // Validate the RightAnswer in the database
        List<RightAnswer> rightAnswers = rightAnswerRepository.findAll();
        assertThat(rightAnswers).hasSize(databaseSizeBeforeUpdate);
        RightAnswer testRightAnswer = rightAnswers.get(rightAnswers.size() - 1);
    ...
    public void deleteRightAnswer() throws Exception {
        ...
        List<RightAnswer> rightAnswers = rightAnswerRepository.findAll();
        assertThat(rightAnswers).hasSize(databaseSizeBeforeDelete - 1);
    }
}
