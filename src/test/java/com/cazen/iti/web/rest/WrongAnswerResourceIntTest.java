...
public class WrongAnswerResourceIntTest {
    ...
    public void createWrongAnswer() throws Exception {
        ...
        List<WrongAnswer> wrongAnswers = wrongAnswerRepository.findAll();
        assertThat(wrongAnswers).hasSize(databaseSizeBeforeCreate + 1);
        WrongAnswer testWrongAnswer = wrongAnswers.get(wrongAnswers.size() - 1);
    ...
    public void updateWrongAnswer() throws Exception {
        ...
        // Validate the WrongAnswer in the database
        List<WrongAnswer> wrongAnswers = wrongAnswerRepository.findAll();
        assertThat(wrongAnswers).hasSize(databaseSizeBeforeUpdate);
        WrongAnswer testWrongAnswer = wrongAnswers.get(wrongAnswers.size() - 1);
    ...
    public void deleteWrongAnswer() throws Exception {
        ...
        List<WrongAnswer> wrongAnswers = wrongAnswerRepository.findAll();
        assertThat(wrongAnswers).hasSize(databaseSizeBeforeDelete - 1);
    }
}
