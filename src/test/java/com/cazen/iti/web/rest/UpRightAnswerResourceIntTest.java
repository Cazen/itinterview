...
public class UpRightAnswerResourceIntTest {
    ...
    public void createUpRightAnswer() throws Exception {
        ...
        List<UpRightAnswer> upRightAnswers = upRightAnswerRepository.findAll();
        assertThat(upRightAnswers).hasSize(databaseSizeBeforeCreate + 1);
        UpRightAnswer testUpRightAnswer = upRightAnswers.get(upRightAnswers.size() - 1);
    ...
    public void updateUpRightAnswer() throws Exception {
        ...
        // Validate the UpRightAnswer in the database
        List<UpRightAnswer> upRightAnswers = upRightAnswerRepository.findAll();
        assertThat(upRightAnswers).hasSize(databaseSizeBeforeUpdate);
        UpRightAnswer testUpRightAnswer = upRightAnswers.get(upRightAnswers.size() - 1);
    ...
    public void deleteUpRightAnswer() throws Exception {
        ...
        List<UpRightAnswer> upRightAnswers = upRightAnswerRepository.findAll();
        assertThat(upRightAnswers).hasSize(databaseSizeBeforeDelete - 1);
    }
}
